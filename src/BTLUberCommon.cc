...
std::vector<float> BTLUberCommon::etaBins() {
  ...
  etaBins.push_back( BTLUberCommon::barrelEnd()   );
  etaBins.push_back( BTLUberCommon::endcapStart() );
  etaBins.push_back( 1.9 );
  etaBins.push_back( 2.4 );
  BTLUberCommon::symmetrize( etaBins );
...
void BTLUberCommon::symmetrize( std::vector<float> &etaBins ) {
...
std::vector<int> BTLUberCommon::colors() {
